        ...
        <div className="mb-4">
          ...
          <div
            ...
            onDrop={async (e) => {
              ...
              // Upload to Cloudinary
              setIsUploadingImage(true);
              console.log('Starting Cloudinary upload from drag-drop...');
              const cloudinaryUrl = await uploadToCloudinary(file);
              setIsUploadingImage(false);

              if (cloudinaryUrl) {
                console.log('Cloudinary URL received from drag-drop:', cloudinaryUrl);
                setFormData((prev: Recipe) => ({ ...prev, image_url: cloudinaryUrl }));
                console.log('Form data updated with image URL from drag-drop');
              } else {
                console.log('Cloudinary upload failed from drag-drop');
                setError('Failed to upload image. Please try again.');
              }
            }}
          >
