            ...
            <div className="p-6 rounded-lg h-fit" style={{ backgroundColor: '#ffffff', borderColor: '#e2e8f0', border: '1px solid #e2e8f0' }}>
              ...
              <div className="space-y-2">
                {recipes.map((recipe) => (
                  ...
                  >
                    <p style={{ color: '#1a2632', fontSize: '14px', fontWeight: '500' }}>{recipe.title}</p>
              ...
              <div className="p-6 rounded-lg sticky top-6" style={{ backgroundColor: '#ffffff', borderColor: '#e2e8f0', border: '1px solid #e2e8f0' }}>
                ...
                <div className="space-y-4 mb-6">
                  <div>
                    ...
                    <p style={{ color: '#1a2632', fontSize: '14px', fontWeight: '500' }}>{selectedRecipe.title}</p>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <p style={{ color: '#1a2632', fontSize: '14px' }}>{selectedRecipe.difficulty_level || '-'}</p>
                    </div>
                    <div>
                      <p style={{ color: '#64748b', fontSize: '12px' }}>Prep Time</p>
                      <p style={{ color: '#1a2632', fontSize: '14px' }}>{selectedRecipe.prep_time} min</p>
                    </div>
                    <div>
                      <p style={{ color: '#64748b', fontSize: '12px' }}>Cook Time</p>
                      <p style={{ color: '#1a2632', fontSize: '14px' }}>{selectedRecipe.cook_time} min</p>
                    </div>
                  </div>
