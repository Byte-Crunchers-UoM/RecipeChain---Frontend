 ...
 const validateForm = (): boolean => {
  ...
  const handleImageChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = () => {
      ...
      setFormData((prev: Recipe) => ({ ...prev, image_url: dataUrl }));
    };
    ...
    <form noValidate onSubmit={handleSubmit} className="max-w-4xl mx-auto p-6" style={{ backgroundColor: '#f8fafb', ...formStyles }}>
      ...
      <div className="mb-8 p-6 rounded-lg shadow-sm border" style={{ backgroundColor: '#ffffff', borderColor: '#e2e8f0' }}>
        ...
        <div className="mb-4">
          ...
          <label
            className="flex items-center gap-3 px-4 py-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition"
            style={{ borderColor: '#cbd5e1', borderStyle: 'dashed' }}
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="#0d9488" strokeWidth={1.8}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-1M12 12V4m0 0-3 3m3-3 3 3" />
              <path strokeLinecap="round" strokeLinejoin="round" d="M4 8.5A2.5 2.5 0 0 1 6.5 6H8l1.2-1.7A1 1 0 0 1 10 4h4a1 1 0 0 1 .8.3L16 6h1.5A2.5 2.5 0 0 1 20 8.5v8A2.5 2.5 0 0 1 17.5 19h-11A2.5 2.5 0 0 1 4 16.5v-8Z" />
              <circle cx="12" cy="12.5" r="3.5" stroke="#0d9488" />
            </svg>
            <span style={{ color: imageFileName ? '#1a2632' : '#94a3b8', fontSize: '13px' }}>
              {imageFileName || 'Browse photo from your computer…'}
            </span>
            <input
              type="file"
              accept="image/*"
          ...
          {imagePreview && (
            <div className="mt-3 relative inline-block">
              <img
                ...
                style={{ width: '120px', height: '90px', borderColor: '#e2e8f0' }}
              />
              <button
                type="button"
                onClick={() => {
