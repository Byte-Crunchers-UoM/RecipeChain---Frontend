      ...
      <div className="space-y-8">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium text-gray-900">8,450 XRP</span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-gray-900">2,800 XRP</span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-gray-900">1,200 XRP</span>
              </div>
              <hr className="my-4" />
              <div className="flex items-center justify-between pt-2">
                <span className="text-sm font-semibold text-gray-900">Total This Month</span>
                <span className="font-bold text-lg text-cyan-600">12,450 XRP</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="bg-cyan-600 text-white px-4 py-2 rounded-lg hover:bg-cyan-700 font-medium text-sm">
              + Add New Recipe
            </button>
          </div>
