...
export default function RecipesPage() {
  ...
  return (
    <DashboardLayout>
                  ...
                  <div className="p-4 flex-grow flex flex-col justify-between">
                    ...
                    <div className="flex flex-col gap-2">
                      {recipe.approval_status?.toLowerCase() === 'pending' ? (
                        <Link href={`/recipes/${recipe.recipe_id}`} className="w-full">
                        ...
                        <button 
                          onClick={() => router.push(`/recipes/add?id=${recipe.recipe_id}`)}
      ...
      {showRejectedToast && (
        <div className="fixed right-5 top-5 z-50 w-80 rounded-2xl border border-red-200 bg-white shadow-xl ring-1 ring-black/5">
